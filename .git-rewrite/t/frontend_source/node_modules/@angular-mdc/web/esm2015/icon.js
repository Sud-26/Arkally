 ...
 */
import { Directive, SecurityContext, Injectable, Optional, Inject, defineInjectable, inject, SkipSelf, InjectionToken, Component, ViewEncapsulation, ChangeDetectionStrategy, ElementRef, Attribute, Input, NgModule } from '@angular/core';
...
/** @nocollapse */
MdcIconRegistry.ctorParameters = () => [
    { type: HttpClient, decorators: [{ type: Optional }] },
    { type: DomSanitizer },
    { type: undefined, decorators: [{ type: Optional }, { type: Inject, args: [DOCUMENT,] }] }
];
/** @nocollapse */ MdcIconRegistry.ngInjectableDef = defineInjectable({ factory: function MdcIconRegistry_Factory() { return new MdcIconRegistry(inject(HttpClient, 8), inject(DomSanitizer), inject(DOCUMENT, 8)); }, token: MdcIconRegistry, providedIn: "root" });
/**
 * \@docs-private
 ...
 * @type {?}
 */
const MDC_ICON_LOCATION = new InjectionToken('mdc-icon-location', {
    providedIn: 'root',
...
class MdcIcon {
    ...
    _clearSvgElement() {
        /** @type {?} */
        const layoutElement = this._getHostElement();
        /** @type {?} */
    ...
    _updateFontIconClasses() {
        ...
        /** @type {?} */
        const elem = this._getHostElement();
        /** @type {?} */
         ...
         * @return {?}
         */
        className => elem.classList.remove(className)));
...
export { MdcIconModule, MDC_ICON_LOCATION_FACTORY, MDC_ICON_LOCATION, MdcIcon, getMdcIconNameNotFoundError, getMdcIconNoHttpProviderError, getMdcIconFailedToSanitizeUrlError, getMdcIconFailedToSanitizeLiteralError, ICON_REGISTRY_PROVIDER_FACTORY, MdcIconRegistry, ICON_REGISTRY_PROVIDER, MdcMaterialIcons };
