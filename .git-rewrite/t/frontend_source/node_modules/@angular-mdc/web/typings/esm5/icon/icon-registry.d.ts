 ...
 */
export declare function getMdcIconNameNotFoundError(iconName: string): Error;
/**
 * Returns an exception to be thrown when the consumer attempts to use
 * `<mdc-icon>` without including @angular/http.
 * @docs-private
 */
export declare function getMdcIconNoHttpProviderError(): Error;
/**
 * Returns an exception to be thrown when a URL couldn't be sanitized.
 * @param url URL that was attempted to be sanitized.
 * @docs-private
 */
export declare function getMdcIconFailedToSanitizeUrlError(url: SafeResourceUrl): Error;
/**
 * Returns an exception to be thrown when a HTML string couldn't be sanitized.
 * @param literal HTML that was attempted to be sanitized.
 * @docs-private
 */
export declare function getMdcIconFailedToSanitizeLiteralError(literal: SafeHtml): Error;
/**
 ...
 */
export declare class MdcIconRegistry implements OnDestroy {
    private _httpClient;
    private _sanitizer;
    private _document;
    /**
...
/** @docs-private */
export declare function ICON_REGISTRY_PROVIDER_FACTORY(parentRegistry: MdcIconRegistry, httpClient: HttpClient, sanitizer: DomSanitizer, document?: any): MdcIconRegistry;
/** @docs-private */
export declare const ICON_REGISTRY_PROVIDER: {
    provide: typeof MdcIconRegistry;
