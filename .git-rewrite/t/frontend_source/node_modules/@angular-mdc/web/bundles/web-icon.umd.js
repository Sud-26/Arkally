...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/operators'), require('@angular/common'), require('@angular-mdc/web/common'), require('@angular/common/http'), require('@angular/platform-browser'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@angular-mdc/web/icon', ['exports', '@angular/core', 'rxjs/operators', '@angular/common', '@angular-mdc/web/common', '@angular/common/http', '@angular/platform-browser', 'rxjs'], factory) :
    (global = global || self, factory((global.ng = global.ng || {}, global.ng.web = global.ng.web || {}, global.ng.web.icon = {}), global.ng.core, global.rxjs.operators, global.ng.common, global.ng.web.common, global.ng.common.http, global.ng.platformBrowser, global.rxjs));
}(this, function (exports, core, operators, common, common$1, http, platformBrowser, rxjs) { 'use strict';
    ...
    var MdcIcon = /** @class */ (function () {
        ...
        Object.defineProperty(MdcIcon.prototype, "inline", {
             ...
             */
            function (inline) {
                this._inline = common$1.toBoolean(inline);
            },
            enumerable: true,
            configurable: true
        });
        ...
        Object.defineProperty(MdcIcon.prototype, "clickable", {
             ...
             */
            function (value) {
                this._clickable = common$1.toBoolean(value);
                if (this._clickable) {
                    this.tabIndex = 0;
                    this.role = 'button';
                }
...
//# sourceMappingURL=web-icon.umd.js.map
