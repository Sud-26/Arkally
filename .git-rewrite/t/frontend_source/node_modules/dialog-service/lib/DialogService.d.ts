 ...
 *  based dialogs.
 */
export declare abstract class DialogService {
    /**
     ...
     * MatDialogConfig.
     */
    abstract withProgress<T = any>(work: Observable<T>, title?: string, options?: {
        dialogOptions?: {
            [key: string]: any;
        };
     ...
     */
    abstract withForm(title: string, fields: QuickFormField[], options?: {
        content?: string;
        submitButton?: string;
        cancelButton?: string;
        layout?: {
