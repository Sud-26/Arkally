...
class Echo(Protocol):
    ...
    def trigger_action_on_intersect_detect_check_end_location(self, data):
        ...
        if len(data) > 0:            
            ...
            extended_time_after_slots_completed=self.convertMinst(extended_time_after_slots_completed)
            #check percent timer completed
            timer_spend_in_percent=total_timer_spend_time_minutes/alarm_time_sltos
            timer_spend_in_percent=timer_spend_in_percent*100
            print("timer completed")
            print(timer_spend_in_percent)
            if timer_spend_in_percent>90:
                ...
                traceble_object_id,traceble_user_id,extended_time_after_slots_completed,data[0][0],))                
    ...
    def trigger_action_on_intersect_detect_check_end_location_timer_start(self, data):
        ...
        if len(data) > 0:
            ...
            command_data_end_location = conn.runQuery(create_vehicle_wise_rent_statics, (traceble_object_id,alarm_on_tme,
                alarm_time_sltos,traceble_user_id,extended_time_after_slots_completed,))  
    ...
    def dataReceived(self, data):
        ...
        try:
            ...
            if message_id == 0xB:
                ...
                print("========== POOL COMMANDS CALLED by kahlid! ==========\n")
                #print(create_hw_module_user_position_element_query,value_tuple)
                hw_mod_user_pos_data = conn.runQuery(
                    create_hw_module_user_position_element_query, value_tuple)
                print(hw_mod_user_pos_data)
