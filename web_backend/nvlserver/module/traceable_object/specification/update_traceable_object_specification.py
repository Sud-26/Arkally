...
update_traceable_object_buzzer_on_off_element_query = """
UPDATE public.traceable_object AS tob
SET buzzer_on                   = $2
WHERE  tob.id = $1::BIGINT
RETURNING *;
...
update_traceable_object_buzzer_on_off_element_query_cron = """
UPDATE public.traceable_object AS tob
SET buzzer_on                   = $2,
cron_status                 = $3
WHERE  tob.id = $1::BIGINT
...
update_traceable_object_command_action_query = """
UPDATE public.traceable_object AS tob
SET disable_engine_start    = $2,
stop_engine                 = $3
WHERE  tob.id = $1::BIGINT
RETURNING *;
 """