...
traceable_object = Table(
    ...
    Column('cron_status', String(length=20),  default=''),
    ...
    Column('active', Boolean, default=True),
    Column('deleted', Boolean, default=False),
    Column('alarm_on_tme', DateTime(timezone=True)),
    Column('alarm_start', BigInteger),
    Column('alarm_state', Boolean, default=False),
    Column('alarm_pause_time', DateTime(timezone=True)),
    Column('alarm_pause_duration', BigInteger),
    Column('alarm_pause_status', Boolean, default=False),
    Column('buzzer_on', Boolean, default=False),
    Column('created_on', DateTime(timezone=True), server_default=func.now(), nullable=False),
    Column('updated_on', DateTime(timezone=True),
           server_default=func.now(), onupdate=func.now(), nullable=False)
)
