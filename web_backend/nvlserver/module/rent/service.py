...
from .specification.get_rent_specification import (
    ...
    get_rent_element_query,get_alarm_timein_query
)
from .specification.delete_rent_specification import delete_rent_element_query
from .specification.update_rent_specification import update_rent_element_query,update_rent_element_alarm_query
...
async def update_rent_element_alarm(
        request: Request,
        rent_id: object = None,        
        alarm_status: bool = False) -> list:
    """Update rent element
    ...
    query_str = update_rent_element_alarm_query

    try:
        async with request.app.pg.acquire() as connection:

            row = await connection.fetchrow(
                query_str, rent_id, alarm_status)
    ...
    try:
        async with request.app.pg.acquire() as connection:
            ...
            row = await connection.fetchrow(
                ...
                state, traceable_object_id, hw_module_id, ack_message, date_from, date_to, alarm_time, active)
