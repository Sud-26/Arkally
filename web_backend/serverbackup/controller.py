...
from .service import (
    ...
    get_traceable_object_brand_dropdown_list, get_traceable_object_model_dropdown_list, update_traceable_object_alram_time_element
)
        ...
        try:
            ...
            for device in traceable_list:
                ...
                if alarm_start:                    
                    ...
                    hw_action_id = 6 #SOUND BUZZER
                    value = True
                    if (datetime.datetime.now()>=alrmbeforetime) and alarm_status is False:
                        hw_action = await get_hw_action_element(request, hw_action_id)
                        ...
                        if created_command:                       
                            traceable_object = await update_traceable_object_alram_time_element(
                                    request, alarm_start=alarm_start, alarm_on_tme=alarm_on_tme, traceable_object_id=traceable_object_id,alarm_state=True)           
